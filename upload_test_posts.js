...
Markdown 的简洁语法让写作变得更加专注和高效。`,
  ...
  'posts/en/2025/08/welcome-to-my-blog.mdx': `---
...
updatedAt: "2025-08-24 15:30:00"
draft: false
tags: ["Blog", "Next.js", "Technology"]
---

Welcome to my technical blog! This space is dedicated to sharing development experiences, frontend technology exploration, and tool usage insights for international projects.
...
Stay tuned for more updates!`,
  ...
  'posts/en/2025/08/cloudflare-pages-migration.mdx': `---
...
updatedAt: "2025-08-25 08:00:00"
draft: false
tags: ["Cloudflare", "Next.js", "Migration", "Deployment"]
---

This article provides a detailed guide on how to completely migrate a Next.js blog from Vercel to Cloudflare Pages, including static export configuration, Functions refactoring, and R2 storage integration.
...
async function uploadPosts() {
  ...
  console.log('开始上传测试博客数据到 R2...');

  for (const [key, content] of Object.entries(testPosts)) {
    try {
      console.log(`上传: ${key}`);
      ...
      if (response.ok) {
        ...
        console.error(`❌ ${key} 上传失败:`, error);
      }
    } catch (error) {
      console.error(`❌ ${key} 上传出错:`, error.message);
    }
  }
...
if (typeof globalThis !== 'undefined' && globalThis.fetch) {
  ...
  console.error('此脚本需要在支持 fetch API 的环境中运行');
}